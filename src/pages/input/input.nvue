 ...
 * @LastEditors: airobot
 * @LastEditTime: 2022-04-11 21:39:30
 * @Description: 输入框
-->
...
<template>
    <ai-page background="white">
        ...
        <ai-box title="圆形" direction="row">
            <ai-input placeholder="请输入内容" border="surround" shape="circle" />
        </ai-box>

        <ai-box title="前后图标" direction="row">
        ...
        <ai-box title="前后插槽" direction="row">
