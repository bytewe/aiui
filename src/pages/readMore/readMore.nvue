...
<template>
    <ai-page background="white" padding>
        <ai-read-more ref="uReadMore" :show-height="showHeight" toggle @open="open" @close="close">
            <ai-parse :content="content" :tag-style="tagStyle" @load="load" />
        </ai-read-more>
    </ai-page>
</template>
...
export default {
    data() {
        return {
            ...
            showHeight: 200,
            tagStyle: {
                p: 'color: #606266; line-height: 48rpx;',
            },
        };
    },
    methods: {
