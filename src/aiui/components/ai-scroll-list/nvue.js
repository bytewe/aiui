...
export default {
    methods: {
        // 此处不写注释，请自行体会
        nvueScrollHandler(e) {
            const anchor = this.$refs['ai-scroll-list__scroll-view'].ref
            const element = this.$refs['ai-scroll-list__indicator__line__bar'].ref
            ...
            const actionNum = uni.$util.os() === 'ios' ? 2 : 1
